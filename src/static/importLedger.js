...
export const steps = [
  ...
  {
    id: 2,
    stepDesc: t('steps.importLedger.step2stepDesc'),
    icon: 'hardware',
    headerTitle: t('steps.importLedger.step2stepDesc'),
    headerInfo: t('steps.importLedger.step2headerInfo'),
    status: 'active',
  },
  {
    id: 3,
    ...
    headerInfo: t('steps.importLedger.step3headerInfo'),
    status: 'inactive',
  },
  {
    id: 4,
