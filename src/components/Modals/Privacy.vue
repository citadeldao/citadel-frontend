      ...
      >
        <div class="policy">
          ...
          <ul>
            <li>
              <p>
                <span class="bold">You</span> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
              </p>
            </li>
            <li>
              <p>
                <span class="bold">Company</span> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Citadel.One Pte. Ltd., 160 ROBINSON ROAD #24-09 SINGAPORE (068914).
              </p>
            </li>
            <li>
              <p>
                <span class="bold">Affiliate</span> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.
              </p>
            </li>
            <li><p><span class="bold">Account</span> means a unique account created for You to access our Service or parts of our Service.</p></li>
            <li><p><span class="bold">Website</span> refers to https://citadel.one</p></li>
            <li><p><span class="bold">Service</span> refers to the Website.</p></li>
            <li><p><span class="bold">Country</span> refers to: Singapore</p></li>
            <li>
              <p><span class="bold">Service Provider</span> means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.</p>
            </li>
            <li>
              <p><span class="bold">Third-party Social Media Service</span> refers to any website or any social network website through which a User can log in or create an account to use the Service.</p>
            </li>
            <li>
              <p><span class="bold">Personal Data</span> is any information that relates to an identified or identifiable individual.</p>
            </li>
            <li>
              <p><span class="bold">Cookies</span> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</p>
            </li>
            <li>
            ...
            <li>
              <p><span class="bold">Usage Data</span> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
            </li>
          </ul>
          ...
          <h2>Data deletion</h2>
          <p>User email is stored by Citadel.one unless the account is deleted. User has an option to erase all the private information by deleting the account in Citadel.one Application settings. After confirmation of deletion, no private information of the user will remain stored.</p>
